...
$paypal_id='pay@superbnexus.com'; // Business email ID
?>
<h4>Welcome, Nirjhor Anjum</h4>
...
<div class="product">            
    ...
    <input type="hidden" name="cpp_header_image" value="http://www.superbnexus.com/logoSN.jpg">
